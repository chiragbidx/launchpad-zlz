...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    ...
    return {
      ...
      description: "Access your campaigns and contacts",
      button: "Sign In",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Power your next campaign with MailForge.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Beautiful campaigns, reliable delivery, and collaboration—all in one seamless dashboard.
              </p>
            </div>
        ...
        <div className="flex min-h-[720px] items-center justify-center p-4 sm:p-8 lg:p-10">
          <Card id={content.id} className="w-full max-w-md border-secondary/70 shadow-xl">
            ...
            <CardContent className="space-y-6">
                ...
                <form className="space-y-4" action={signUpAction}>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="signup-first-name" name="firstName" placeholder="Adan" required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="signup-last-name">Last name</Label>
                      <Input id="signup-last-name" name="lastName" placeholder="Asim" required />
                    </div>
                  </div>
              ...
              {/* Helper text for legal/terms */}
              <p className="text-xs text-muted-foreground text-center">
                By continuing, you agree to the MailForge Terms and Privacy Policy.
              </p>
